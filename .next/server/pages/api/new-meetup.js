...
const handler = async (req, res) => {
  if (req.method === "POST") {
    ...
    const client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect("mongodb+srv://root:root@cluster0.s6p7c.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
