...
// CONCATENATED MODULE: ./components/meetups/MeetupDetil.js
...
/* harmony default export */ var MeetupDetil = (MeetupDetail);
...
const MeetupDetails = props => {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(external_react_["Fragment"], {
    ...
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(MeetupDetil, {
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://root:root@cluster0.s6p7c.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
async function getStaticProps(context) {
  ...
  return {
    props: {
      meetupData: _objectSpread(_objectSpread({}, meetup.data), {}, {
        id: meetup._id.toString() // title: meetup.
